...
Instructions: Run program, it will sak you for data file.
In the bin\Debug folder you can find sample data files: job1.txt, job2.txt, job3.txt
Receipt Receipt.txt will be saved in the same folder.